...
/**
 * Created by Konstantin on 12/01/2017.
 */

public class MesurmentsConvertor {
    public static float convertTemperature(float temperature, SharedPreferences sp) {
        if (sp.getString("unit", "C").equals("C")) {
            return MesurmentsConvertor.kelvinToCelsius(temperature);
        } else if (sp.getString("unit", "C").equals("F")) {
            return MesurmentsConvertor.kelvinToFahrenheit(temperature);
        } else {
            return temperature;
        }
    }
