...
// something is wrong when I use networkConnectionCheck net
    private boolean isNetworkAvailable() {
        ...
        public class GetWeatherTask extends AsyncTask<String, String, Void> {
            ...
            protected Void doInBackground(String... params) {
                ...
                try {
                    ...
                    URL url = new URL("http://api.openweathermap.org/data/2.5/weather?q=" + URLEncoder.encode(sp.getString("city", DefaultCity.DEFAULT_CITY), "UTF-8") + "&lang="+ language +"&appid=" + apiKey);
        ...
        public static void setRecurringAlarm(Context context) {
            ...
            Intent refresh = new Intent(context, Updater.class);
